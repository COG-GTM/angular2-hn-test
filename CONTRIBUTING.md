...
5. Run `npm run dev` and open the local dev server URL in a browser
6. Work your magic
7. Run `npm run build` or `npm run static-serve` to kick off a production build and make sure nothing is broken
